...
function redirectToTelegram(planType) {
    ...
    switch (planType) {
        ...
        case 'pro':
            ...
            break;
        case 'limited':
            message = '?text=Hi! I\'m interested in the Limited Edition plan ($60/month) for Tatsumi Crew - DNS Tools. Can you help me get started with the 14-day free trial?';
            break;
        case 'enterprise':
            message = '?text=Hi! I\'m interested in the Hot Limited plan ($110/month) for Tatsumi Crew - DNS Tools. I\'d like to discuss custom solutions for my organization.';
            break;
        default:
